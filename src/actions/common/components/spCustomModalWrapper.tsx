...
export class SpCustomModalWrapper extends React.Component<ISpCustomModalWrapperProps, {}> {
    ...
    public render() {
        return (
            <div className="chrome-sp-dev-tool-wrapper">
                <div className="sp-dev-too-modal"
                    style={(this.props.modalWidth !== undefined) ? { width: this.props.modalWidth } : {}}>
                    <div className="sp-dev-tool-modal-header">
                        <span className="ms-font-xxl ms-fontColor-themePrimary ms-fontWeight-semibold">
                            {this.props.modalDialogTitle}
                        </span>
                        <a title={constants.MODAL_WRAPPER_CLOSE_BUTTON_TEXT}
